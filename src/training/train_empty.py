...
from src.nn.loss_functions.hinge_loss import hinge_loss
from src.training.epoch_information import EpochInformation
    ...
    * Если return_history=False
    ...
    for epoch in range(epochs):
        ...
        for vecs, labels in progress_bar(dataloader):
            ...
            predictions = model.forward(vecs)
        ...
        if (epoch + 1) % step == 0 or (epoch + 1) == epochs:
            ...
            for vecs, labels in progress_bar(dataloader,
                ...
                train_acc.append(np.mean(predictions == labels))
            ...
            if valid_dataset:
                ...
                for vecs, labels in progress_bar(valid_dataloader,
                    ...
                    valid_acc.append(np.mean(predictions == labels))
